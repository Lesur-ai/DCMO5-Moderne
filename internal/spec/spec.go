...
// Carte mémoire MO5
const (
	RAMVideoSize = 0x2000 // 8 Ko RAM vidéo (formes + couleurs, 2 pages de 8 Ko chacune)
	RAMUserSize  = 0xA000 // ~40 Ko RAM utilisateur (0x0000–0x9FFF, partie accessible)
	RAMTotalSize = 0xC000 // 48 Ko RAM totale
...
const (
	AddrVideoRAM   uint16 = 0x0000 // base RAM vidéo (couleurs)
	AddrVideoForms uint16 = 0x2000 // base RAM vidéo (formes)
	AddrUserRAM    uint16 = 0x0000 // base RAM utilisateur (même page, banque distincte)
	AddrROMSys     uint16 = 0xC000 // base ROM système
	AddrCart       uint16 = 0xB000 // base cartouche / ROM banque
...
// Palette Thomson MO5 (16 couleurs + 3 couleurs système)
// Référence: dcmo5video.c Initpalette() — composantes R,G,B sur [0,15],
// correction gamma appliquée par le rendu.
...
var Palette = [19][3]uint8{
	//      R    G    B  (index dans table gamma [0,15] → [0,255])
	/* 0 */ {0, 0, 0},
	/* 1 */ {15, 0, 0},
	/* 2 */ {0, 15, 0},
	/* 3 */ {15, 15, 0},
